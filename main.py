...
class Human:
    ...
    def days_indexes(self, day):
        ...
        print(f"{human_i:=^50}")
        print(f"{self.money, self.satiety, self.gladness, self.thirst}")
        print(f"{'Home indexes':=^50}")
        print(f"{self.home.food, self.home.water, self.home.mess}")
...
class Super(Auto):
    def __init__(self):
        super().__init__(f"BMW M3 GTR")

        print(f"your car have issues...")

    def motor_issue(self):
        if self.fuel < 50:
            self.strength -= 1
